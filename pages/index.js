...
export default function Home() {
  ...
  // i can not get transaction eth sepolia
  // if token link  i can get transaction, but i cant get address link
  // get random with chainlink
            ...
            <div className="navbar-end">
              {connectedAccount ? (
                ...
                font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center
                 dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white
